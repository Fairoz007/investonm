...
export default function ForgotPassword() {
 ...
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[var(--primary)] rounded-full opacity-[0.03] -mr-64 -mt-64 pointer-events-none" />
 <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[var(--primary)] rounded-full opacity-[0.03] -ml-64 -mb-64 pointer-events-none" />
...
>
 ...
 <div className="inline-block mb-4 p-4 rounded-2xl (--primary)] (--accent)] shadow-lg shadow-[var(--primary)]/20">
 ...
 {/* Form Container */}
 <motion.div
 className="bg-white border border-[var(--accent)]/10 rounded-[2.5rem] p-6 sm:p-8 md:p-10 overflow-hidden"
>
 {!isSubmitted ? (
