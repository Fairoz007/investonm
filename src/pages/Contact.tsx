        ...
        <div className="min-h-screen text-slate-300 overflow-hidden pt-20">
            ...
            <section className="relative h-[350px] flex items-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-[#0b0f19]/90 via-[#0b0f19]/60 to-[#0b0f19]" />
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start">
                        ...
                        <div className="lg:col-span-8">
                            <motion.form
                                ...
                                className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 sm:p-10 card-premium-alt shadow-2xl"
            ...
            <section className="py-16 md:py-24 border-t border-white/5">
                <div className="container-custom">
                    <div className="w-full h-[500px] rounded-3xl overflow-hidden border border-white/10 relative grayscale brightness-75 hover:grayscale-0 hover:brightness-100 transition-all duration-1000 shadow-2xl">
                        <iframe
