...
export default function SignIn() {
 ...
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary rounded-full opacity-[0.05] -mr-64 -mt-64 pointer-events-none" />
 <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-primary rounded-full opacity-[0.05] -ml-64 -mb-64 pointer-events-none" />
...
>
 ...
 <div className="inline-block mb-4 p-4 rounded-2xl shadow-lg shadow-primary/20">
 ...
 className="bg-white border border-border rounded-[2.5rem] p-6 sm:p-8 md:p-10"
>
