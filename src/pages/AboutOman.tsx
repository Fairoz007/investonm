              ...
              >
                <div className="lg:w-1/2 space-y-10">
                  <div className="flex items-center gap-6">
                    <div className="w-20 h-20 rounded-2xl bg-blue-600/10 flex items-center justify-center shadow-2xl backdrop-blur-xl border border-white/10 group transition-all hover:bg-blue-600">
                ...
                <div className="lg:w-1/2 w-full">
                  <div className="aspect-[1.6] rounded-3xl overflow-hidden shadow-2xl border border-white/10 relative group">
                    <div
                      className="absolute inset-0 bg-cover bg-center transition-transform duration-[4000ms] group-hover:scale-110 grayscale-[20%] group-hover:grayscale-0"
