...
>
 ...
 {offices.map((office) => (
 <div key={office.region} className="bg-card border border-border rounded-lg p-6 shadow-sm p-6">
...
>
 ...
 <div className="mt-6 bg-card border border-border rounded-lg p-6 shadow-sm p-6">
 <div className="flex items-center gap-3 mb-4">
 ...
 <div className="container-custom">
 <ScrollReveal>
 <div className="bg-card border border-border rounded-lg p-6 shadow-sm p-12 text-center">
