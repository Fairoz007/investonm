          ...
          <div className="grid md:grid-cols-2 gap-8">
            {supportAreas.map((area, index) => (
              <ScrollReveal key={area.title} delay={index * 0.1}>
                <motion.div
                  whileHover={{ y: -5 }}
                  className="bg-white/5 backdrop-blur-sm border border-white/10 p-10 rounded-2xl h-full transition-all duration-300 hover:bg-white/10 group text-left"
                >
                  <div className="p-4 bg-primary/20 rounded-2xl w-fit mb-8 transition-transform duration-300 group-hover:scale-110">
