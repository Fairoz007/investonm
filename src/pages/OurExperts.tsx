      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mb-20">
          {experts.filter(e => e.id === 'chairman').map((chairman) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="card-premium p-8 lg:p-12 flex flex-col lg:row gap-12 relative overflow-hidden group"
            >
              ...
              <div className="lg:w-[30%] flex flex-col items-center">
                <div className="relative mb-8 w-full aspect-square max-w-[300px]">
                  ...
                  <div className="relative w-full h-full rounded-2xl overflow-hidden border-2 border-[#374151] shadow-2xl">
                    <img 
                      src={chairman.image} 
                      alt={chairman.name} 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 md:mb-40">
          {experts.filter(e => e.id !== 'chairman').map((expert, idx) => (
            <motion.div
              ...
              className="card-premium p-8 group cursor-pointer flex flex-col items-center text-center"
              onClick={() => setSelectedExpert(expert)}
            >
              <div className="relative mb-8 w-48 h-48 rounded-full overflow-hidden border-4 border-[#374151] shadow-2xl group-hover:border-blue-500/50 transition-all duration-500">
        ...
        <div className="mb-40 grid grid-cols-1 lg:grid-cols-2 gap-12">
           <motion.div 
             ...
             className="card-premium p-12 bg-gradient-to-br from-blue-900/10 to-transparent border-blue-500/10"
           >
          ...
          {selectedExpert && (
            <Dialog open={!!selectedExpert} onOpenChange={(open) => !open && setSelectedExpert(null)}>
              <DialogContent className="max-w-6xl w-[95vw] lg:w-full p-0 border-none bg-transparent shadow-none">
                <div className="relative w-full h-full lg:h-[80vh] flex flex-col lg:flex-row glass-modal overflow-hidden">
                  {/* Close button */}
                  <button 
                  ...
                  {/* LEFT PANEL - Identity */}
                  <div className="w-full lg:w-[45%] bg-gradient-to-br from-[#0b0f19] to-[#1e3a8a] p-12 flex flex-col items-center justify-center text-center relative shrink-0">
                    <div className="relative mb-10">
                      <div className="absolute inset-0 bg-blue-500/20 rounded-full blur-3xl scale-125" />
                      <div className="relative w-48 h-48 lg:w-64 lg:h-64 rounded-full p-2 border-2 border-white/10 overflow-hidden shadow-2xl">
                        <img 
