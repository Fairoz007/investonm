...
export const ResearchDataCTA = () => {
  return (
    <section className="py-16 lg:py-20 overflow-hidden relative bg-transparent border-t border-white/[0.03]">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        <ScrollReveal>
          <div className="glass-card-premium rounded-[32px] sm:rounded-[48px] p-5 sm:p-8 lg:p-10 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 sm:gap-16 text-left">
              <div className="max-w-xl text-white space-y-6 sm:space-y-8">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[64px] font-black leading-[1.05] tracking-tighter">
                  Need specific <span className="gradient-text">data</span> for your sector?
                </h2>
                ...
                <button className="group inline-flex w-full sm:w-auto min-h-[56px] items-center justify-center rounded-full bg-gradient-to-r from-[#2563EB] to-[#3B82F6] px-8 sm:px-10 py-4 text-sm sm:text-base font-bold text-white transition-all hover:scale-[1.02] hover:brightness-110 shadow-[0_15px_35px_rgba(59,130,246,0.4)] border border-[#60A5FA]/30 touch-target">
                  Request Custom Report
                </button>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8 w-full lg:w-auto">
                <div className="p-5 sm:p-8 bg-white/[0.02] rounded-[24px] sm:rounded-[32px] border border-white/[0.05] text-white group/item hover:bg-white/[0.05] hover:border-blue-500/30 transition-all backdrop-blur-xl hover:translate-y-[-5px] duration-500">
                  ...
                  <h4 className="font-black text-xl sm:text-2xl mb-2 sm:mb-3 tracking-tight">Global Data</h4>
                  <p className="text-sm sm:text-[15px] text-slate-400 leading-relaxed font-bold opacity-80">Access worldwide market trends and benchmarks for your investment.</p>
                </div>

                <div className="p-5 sm:p-8 bg-white/[0.02] rounded-[24px] sm:rounded-[32px] border border-white/[0.05] text-white group/item hover:bg-white/[0.05] hover:border-purple-500/30 transition-all backdrop-blur-xl hover:translate-y-[-5px] duration-500">
                  ...
                  <h4 className="font-black text-xl sm:text-2xl mb-2 sm:mb-3 tracking-tight">Trusted Source</h4>
                  <p className="text-sm sm:text-[15px] text-slate-400 leading-relaxed font-bold opacity-80">Verified government and institutional data you can rely on.</p>
                </div>
              </div>
            </div>
          </div>
