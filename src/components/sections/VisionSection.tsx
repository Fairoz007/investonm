...
export const VisionSection = () => {
 ...
 <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[var(--primary)] rounded-full opacity-20" />
 <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-600 rounded-full opacity-20" />
 </div>
 ...
 <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 h-full flex flex-col justify-between">
...
"Our Vision is a strong, thriving, and stable Oman that provides
 ...
 <div className="w-16 h-16 rounded-full (--primary)] (--primary-dark)] flex items-center justify-center shadow-lg">
