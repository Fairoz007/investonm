...
export const WhyInvestSection = () => {
  return (
    <section id="why-invest" className="py-24 bg-gradient-to-b from-[#0F172A] to-[#020617] relative overflow-hidden">
      <div className="container-custom relative z-10">
        ...
        <div className="relative">
              ...
              <StaggerItem key={card.id}>
                <motion.div
                  ...
                  className={`flex-shrink-0 w-[300px] md:w-[340px] h-[340px] rounded-[2.5rem] p-8 
                              ...
                              relative overflow-hidden cursor-pointer group snap-start shadow-2xl`}
                >
                  {/* Background Decoration */}
                  <div className="absolute top-0 right-0 w-40 h-40 bg-[var(--primary)]/20 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          ...
          {/* Gradient Fade Edges */}
          <div className="absolute left-0 top-0 bottom-4 w-12 bg-gradient-to-r from-[#0F172A] to-transparent pointer-events-none md:hidden" />
          <div className="absolute right-0 top-0 bottom-4 w-12 bg-gradient-to-l from-[#020617] to-transparent pointer-events-none md:hidden" />
        </div>
      </div>
    </section>
