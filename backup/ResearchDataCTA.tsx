...
export const ResearchDataCTA = () => {
 ...
 <ScrollReveal>
 <div className=" rounded-[3.5rem] p-12 md:p-24 relative overflow-hidden border border-white/5">
 <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[var(--primary)]/10 rounded-full -mr-48 -mt-48 pointer-events-none" />
 <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-600/10 rounded-full -ml-48 -mb-48 pointer-events-none" />
 ...
 <button className="px-10 py-5 bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-white rounded-full font-bold font-sans transition-all transform shadow-[0_10px_40px_rgba(30,58,138,0.4)] uppercase text-xs tracking-[0.2em]">
 Request Custom Report
 </button>
 </div>
 
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full lg:w-auto">
 <div className="p-10 bg-white/5 rounded-[2.5rem] border border-white/10 text-white group hover:bg-white/10 hover:border-[var(--primary)]/50 transition-all">
 ...
 <div className="p-10 bg-white/5 rounded-[2.5rem] border border-white/10 text-white group hover:bg-white/10 hover:border-[var(--primary)]/50 transition-all">
 <div className="w-16 h-16 rounded-2xl bg-[var(--primary)]/10 flex items-center justify-center mb-8 group-hover:bg-[var(--primary)] transition-colors">
 <ShieldCheck className="w-8 h-8 text-[var(--primary-light)] group-hover:text-white transition-transform duration-500 group-" />
 </div>
