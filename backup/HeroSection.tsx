...
>
 ...
 <button className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-full border border-white/25 bg-black/35 text-white hover:bg-[var(--primary)] hover:border-[var(--primary)] transition-all duration-200 font-bold font-sans text-xs tracking-[0.1em] uppercase w-full sm:w-auto min-h-[44px] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-black">
 Explore Sectors
 ...
 <button className="p-3 rounded-full bg-black/35 border border-white/20 text-white/80 hover:text-white hover:bg-white/15 transition-all duration-200 min-w-[44px] min-h-[44px] flex items-center justify-center cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-black">
 ...
 className="relative w-24 h-24 flex items-center justify-center rounded-full border border-white/20 cursor-pointer transition-transform duration-500 group"
>
